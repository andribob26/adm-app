...
const ModalCari = ({
  ...
  useLayoutEffect(() => {
    dispatch(getAllBahanBaku({ size: "18", token: dataSession.data?.token }));
  }, []);
                    ...
                    return (
                      ...
                      >
                        <div
                          onClick={() => {
                            ...
                            const modal = window.Modal.getInstance(
                              document.querySelector("#bahanBaku")
                            );
                            modal.hide();
                          }}
                        ...
                        >
                          ...
                          <button
                            className={`${
                              hasMatchId(detailPembelian, item.id) &&
            ...
            <div className="modal-footer tw-flex tw-flex-shrink-0 tw-flex-wrap tw-items-center tw-justify-end tw-py-2 tw-px-6 tw-border-t tw-border-gray-200 tw-rounded-b-md">
              <div className="tw-flex tw-justify-end">
                <ReactPaginate
                  ...
                  pageRangeDisplayed={dataBahanBaku.limit}
                  pageCount={dataBahanBaku.totalPage}
                  forcePage={dataBahanBaku.currentPage}
                  previousLabel={null}
